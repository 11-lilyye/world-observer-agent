...
如果没有指定主题，Agent 会先按输出平台抓热点，再结合你的本地公众号收藏信息源与爆款库生成选题：
...
- 先看平台热点：TrendRadar/newsnow 多平台热榜、RSS/Atom。
- 再结合本地公众号收藏：学习公众号标题、开头、结构、节奏。
- 最后按公众号读者习惯写，不把微博/知乎/抖音的表达方式直接搬进公众号。
